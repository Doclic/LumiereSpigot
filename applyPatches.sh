...
echo
echo "Applying LumiereSpigot patches to PaperSpigot-Server and PaperSpigot-API"
echo
applyPatch PaperSpigot-API LumiereSpigot-API && applyPatch PaperSpigot-Server LumiereSpigot-Server
